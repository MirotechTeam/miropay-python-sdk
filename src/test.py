...
async def main():
    ...
    # -----END PRIVATE KEY-----"""
    secret_key = "test_ipst_94kkcmgKEwvL8DbrgM0mWvr2jb_dvaQdmQXs9m1aw"
    private_key = """-----BEGIN PRIVATE KEY-----
    MC4CAQAwBQYDK2VwBCIEIE6nrGQSuS5NSG8F8ZvVHX7kyA3YQzsZjpCwyEJMMxlc
    -----END PRIVATE KEY-----"""
    ...
    try: 
        get_res = await client.get_payment_by_reference_code(reference_code=creation_res.body.referenceCode)
